...
class FormResetValue extends HTMLElement {
    // State that this web component is form associated (acts like an input)
    static get formAssociated() { return true; }

    // Constructor is called whenever a new FormResetValue class is created
    constructor() {
    ...
    // Form reset callback function. This is called when the "reset" input type is pressed
    formResetCallback() {
...
customElements.define('form-reset-value', FormResetValue);
